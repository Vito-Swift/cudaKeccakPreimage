...
#define u32 uint32_t
    ...
    assert((A_4_2[0][0] & 0x00000744) == 0x00000004);
    assert((A_4_2[1][0] & 0x74400000) == 0x24000000);

    assert((A_4_2[0][0] & 0x00000744) == 0x00000004);
    assert(((A_4_2[0][0] ^ A_4_2[2][0]) & 0xD85678B8) == 0x885068A0);
    assert((A_4_2[1][0] & 0x8B040000) == 0x03000000);
    assert(((A_4_2[1][0] ^ A_4_2[3][0]) & 0x00BB0000) == 0x00A90000);
