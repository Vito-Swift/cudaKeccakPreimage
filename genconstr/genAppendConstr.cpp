...
//    auto m_1 = (A_4_2[0][0] & 0x00000746) ^0x00000006;
//    auto m_2 = (A_4_2[1][0] & 0x74400000) ^0x24000000;
// IMPORTANT:
// --------- for test use round 4 constraints ----------
    auto m_1 = (A_4_2[0][0] & 0xA0000026) ^0x80000020;
    auto m_2 = (A_4_2[1][0] & 0x026A0000) ^0x02420000;
// -----------------------------------------------------

    for (uint32_t i = 0; i < 32; i++) {
        if (m_1.var32[i].poly_ord != 0)
            m_1.display_var(i);
        if (m_2.var32[i].poly_ord != 0)
            m_2.display_var(i);
    }
